 ...
 const mediaDataInfo = [
  ...
  return <Sclinks url={elem.webAddress} icon={elem.class}/>
    ...
    return (
        ...
        <div className="founders flex flex-row my-[50px]" style={{ fontFamily: "Azeret Mono" }}>

            <div className="foundersLeft mr-[45px] flex justify-center items-center flex-shrink-0">

                <img src={dp} alt="founders_image_not_displayed" style={{ borderRadius: "9px", aspectRatio:"1/1", width:"280px", maxWidth:"280px", height:"280px", objectFit:"cover" }} />
            </div>
