...
function FoundingMember() {
    return (
        <div className="FoundingMember my-[80px]">
            ...
            <div className="foundingMemberLabel text-[27px] mx-[160px] my-[20px] text-[#F9E6FF] text-[700]">
                <span style={{fontFamily:"Azeret Mono"}}>Founding Members</span>
            </div>
            <div className="foundingMembers">

                <Founders
                 dp="src/assets/dps/jatin_kr_mehta.jpg" fullName="Jatin Kumar Mehta" designation="Founder (1st Chairman)" academicDetails="B.Tech-CSE, 2022-26"
                ...
                <Founders dp="src/assets/dps/aarzoo_dp.jpg" fullName="Saurabh Kumar Mishra" designation="1st Vice Chairman " academicDetails="B.Tech-CSE, 2022-26"
                ...
                <Founders dp="src/assets/dps/aarzoo_dp.jpg" fullName="Pankaj Kumar Ray" designation="1st Club Coordinator"
                    academicDetails="B.Tech-CSE, 2023-27" desc="Pankaj Kumar Ray served as the first Club Coordinator of Codoko Club and was the main developer during its founding phase, handling key development responsibilities with dedication and skill. He earned great respect from both the founding members and the entire club community. On 4 October 2025, he was appointed as the second Club Chairman by Jatin Kumar Mehta." />
