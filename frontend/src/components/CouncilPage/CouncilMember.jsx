...
instagram:
  ...
  return (
    ...
    <div className="CouncilMember mt-[80px] mx-4 sm:mx-8 md:mx-[80px] lg:mx-[140px] flex-row flex-wrap">
    <div className="CouncilMember mt-[80px] mx-[140px] flex-row flex-wrap ">
      ...
      <div className="councilMemberInfo mt-3 flex justify-start gap-6 flex-wrap items-start">
